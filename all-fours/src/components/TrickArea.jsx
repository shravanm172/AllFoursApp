...
export const TrickArea = ({ trickCards }) => {
  ...
  console.log("🎯 TrickArea rendered with trickCards:", trickCards);
  console.log("🎯 TrickCards length:", trickCards?.length || 0);
  ...
  return (
    <div className="trick-area">
      {["top", "left", "center", "right", "bottom"].map((slot) => {
        ...
        const trick =
          positionIndex >= 0 && trickCards?.[positionIndex]
            ? trickCards[positionIndex]
            : null;
        return (
